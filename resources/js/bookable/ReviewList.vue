        ...
        <div v-else>
            ...
            <div class="border-bottom d-none d-md-block" v-for="(review, index) in reviews" :key="index">
                <div class="row pt-4">
                    ...
                    <div class="col-md-6 d-flex justify-content-end">{{review.rating}}<review-rating :rating ="review.rating"></review-rating></div>
...
export default {
    ...
    created(){
        this.loading = true;
        axios.get(`/api/bookables/${this.bookableId}/review`)
             .then(response =>{
